...
class Airplane {
 ...
 class Lambdasian {
  ...
  const lilLambdasian = new Lambdasian({
    name: 'Jon',
    age: 30,
    location: 'NYC',
  })
  ...
  */
  ...
  grade(studentName, subject){
    return `${studentName.name} receives a perfect score on ${subject}`
  }
  }
 ...
 class Student extends Lambdasian{
    ...
    PRAssignment(subjects){
      return `${this.name} has submitted a PR for ${subjects}`
    }
 ...
 class ProjectManager extends Instructor{
    ...
    debugsCode(studentName, subjects){
      return `${this.name} debugs ${studentName.name}'s code on ${subjects}`
    }
 }
  /*
